...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    player0 = take_turn(strat0, score0, score1, dice, goal=GOAL_SCORE)
    player1 = take_turn(strat1, score1, score0, dice, goal=GOAL_SCORE)
    ...
    while score0 < goal and score1 < goal:
        ...
        if who == 0:
            ...
            if score1 == 0 and rolls0 == 0:
                ...
                score0 += take_turn(rolls0, score0, score1, dice, goal)
            ...
            if score0 == 0 and rolls1 == 0:
                ...
                score1 += take_turn(rolls1, score1, score0, dice, goal)
...
def hog_pile_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    if opponent_score % 10 == score % 10 and hog_pile(score, opponent_score) > 0:
        return 0
    else:
